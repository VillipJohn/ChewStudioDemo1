...
public class DefaultResetFragment extends Fragment {
    ...
    public static DefaultResetFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_default_reset, container, false);

        mToolbar = rootView.findViewById(R.id.defaultResetToolbar);
        ((AppCompatActivity)getActivity()).setSupportActionBar(mToolbar);
        mToolbar.setTitle("Сброс по умолчанию");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                getActivity().getSupportFragmentManager().beginTransaction().remove(DefaultResetFragment.this).commit();
