...
public class SoundsAndNotificationsFragment  extends Fragment {
    ...
    public SoundsAndNotificationsFragment() {
    ...
    public static SoundsAndNotificationsFragment newInstance(String param1, String param2) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                getActivity().getSupportFragmentManager().beginTransaction().remove(SoundsAndNotificationsFragment.this).commit();
